...
HomePage.src = BASE_URL + "HomePage.js";
Container1.appendChild(HomePage);

// Projects Change Category
const projchangecat = document.createElement("script");
projchangecat.src = BASE_URL + "projchangecat.js";
Container1.appendChild(projchangecat);

// Settings Page
const settingspage = document.createElement("script");
settingspage.src = BASE_URL + "settingspage.js";
Container1.appendChild(settingspage);

// Profile Page
const profilepage = document.createElement("script");
profilepage.src = BASE_URL + "profilepage.js";
Container1.appendChild(profilepage);

// Information Page
const informationpage = document.createElement("script");
informationpage.src = BASE_URL + "informationpage.js";
Container1.appendChild(informationpage);

// Pinned
const Pin = document.createElement("script");
Pin.src = BASE_URL + "Pin.js";
document.body.appendChild(Pin);

// data2
const data2 = document.createElement("script");
data2.src = BASE_URL + "data2.js";
