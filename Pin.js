...
leftBarC2.style.display = "none";
leftBarC2.style.flexDirection = "column";
function profshow() {

if(leftBarC2.style.display === "flex"){
  leftBarC2.style.height = "22px";
leftBarC2.style.width = "22px";
leftBarC2.style.marginTop = "50px";
} else if (leftBarC2.style.display === "none"){
    leftBarC2.style.height = "0px";
leftBarC2.style.width = "0px";
leftBarC2.style.marginTop = "0px";
} else{
      leftBarC2.style.height = "0px";
leftBarC2.style.width = "0px";
leftBarC2.style.marginTop = "0px";
...
function getMarginTopWithPx(element) {
    const style = window.getComputedStyle(element);
    return style.getPropertyValue('margin-top');
}

const marginTopOfLeftBarC0 = getMarginTopWithPx(leftBarC0);
const marginTopOfLeftBarC1 = getMarginTopWithPx(leftBarC1);
const marginTopOfLeftBarC2 = getMarginTopWithPx(leftBarC2);
const marginTopOfLeftBarC3 = getMarginTopWithPx(leftBarC3);
const marginTopOfLeftBarC4 = getMarginTopWithPx(leftBarC4);
const marginTopOfLeftBarC5 = getMarginTopWithPx(leftBarC5);
const marginTopOfLeftBarC6 = getMarginTopWithPx(leftBarC6);
...
// leftBarCselector.style.top = "50px";


leftBarCselector.style.top = marginTopOfLeftBarC0;

// HomePage2ptl0p0.style.width = HomePage2ptl0p6.offsetHeight + "px";
...
leftBarCselector.style.top = (parseInt(marginTopOfLeftBarC0) + parseInt(marginTopOfLeftBarC1) + leftBarC1.offsetHeight + leftBarC6.offsetHeight + parseInt(marginTopOfLeftBarC6)) + "px";

// leftBarCselector.style.top = (marginTopOfLeftBarC0 + leftBarC0.offsetHeight + marginTopOfLeftBarC1 + leftBarC1.offsetHeight + leftBarC6.offsetHeight + marginTopOfLeftBarC6) + "px";
...
leftBarCselector.style.top = (parseInt(marginTopOfLeftBarC0) + parseInt(marginTopOfLeftBarC2) + parseInt(marginTopOfLeftBarC1) + leftBarC1.offsetHeight + leftBarC2.offsetHeight + leftBarC6.offsetHeight + parseInt(marginTopOfLeftBarC6)) + "px";
...
leftBarCselector.style.top = (parseInt(marginTopOfLeftBarC0) + parseInt(marginTopOfLeftBarC3) + parseInt(marginTopOfLeftBarC2) + parseInt(marginTopOfLeftBarC1) + leftBarC1.offsetHeight + leftBarC2.offsetHeight + leftBarC3.offsetHeight + leftBarC6.offsetHeight + parseInt(marginTopOfLeftBarC6)) + "px";
...
leftBarCselector.style.top = (parseInt(marginTopOfLeftBarC0) + parseInt(marginTopOfLeftBarC4) + parseInt(marginTopOfLeftBarC3) + parseInt(marginTopOfLeftBarC2) + parseInt(marginTopOfLeftBarC1) + leftBarC1.offsetHeight + leftBarC2.offsetHeight + leftBarC3.offsetHeight + leftBarC4.offsetHeight + leftBarC6.offsetHeight + parseInt(marginTopOfLeftBarC6)) + "px";
} else {
  ActivePage = "Home";
// leftBarCselector.style.top = "57px";
leftBarCselector.style.top = marginTopOfLeftBarC0;
